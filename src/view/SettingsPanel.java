...
/**
 * מסך הגדרות (Settings) מאפשר שליטה בווליום, השתקה ושינוי ערכת נושא.
 */
public class SettingsPanel extends JPanel {
	...
	private void initializeUI() {
		...
		muteCheckBox.addActionListener(e -> SoundManager.getInstance().setMuted(muteCheckBox.isSelected()));
	...
	private class HelpDialog extends JDialog {
		...
		HelpDialog() {
			super(SwingUtilities.getWindowAncestor(SettingsPanel.this), "How to Play – Minesweeper",
			...
			appendSection(text, "🎯", new Color(255, 215, 0), // זהב
			...
			appendSection(text, "🌀", new Color(120, 200, 255), // טורקיז/כחול
					" Turn System:\n",
			...
			appendSection(text, "🧩", new Color(255, 170, 255), // ורוד-סגול
					" Tile Types:\n",
			...
			appendSection(text, "❤️", new Color(255, 100, 140), // אדום-ורוד
			...
			appendSection(text, "⭐", new Color(255, 230, 120), // צהוב-בהיר
		 ...
		 */
		private void appendSection(JTextPane pane, String icon, Color iconColor, String title, String body) {
